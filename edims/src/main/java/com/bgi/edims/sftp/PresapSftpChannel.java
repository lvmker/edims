...
public class PresapSftpChannel {
	private Logger logger=LoggerFactory.getLogger(PresapSftpChannel.class);
    public ChannelSftp channel;
    public PooledObject<Session> session;
    public PresapSftpChannel(PooledObject<Session> session) throws Exception{
	this.session=session;
	this.channel=(ChannelSftp) session.getObject().openChannel("sftp");
    ...
    public boolean uploadTextFile(String pathName,String fileName,String context) throws UnsupportedEncodingException{
